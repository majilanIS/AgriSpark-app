...
export default function FarmerHomeScreen() {
  ...
  const fetchDashboard = useCallback(async () => {
    ...
    setPendingOrders((orderRows || []).filter((order) => String(order.status || "").toLowerCase() === "pending").length);
  }, []);
    ...
    <Fragment>
      ...
      <Modal visible={chatOpen} animationType="slide" presentationStyle="fullScreen" onRequestClose={() => setChatOpen(false)}>
        <View style={styles.modalScreen}>
          ...
          <AgriSparkAIChatbot autoGreeting dashboardRole="farmer" dashboardPage="Farmer Dashboard" />
        </View>
      </Modal>
    </Fragment>
  );
