...
export default function FarmerCreateScreen() {
  ...
  const categories = ["Vegetables", "Fruits", "Grains", "Dairy", "Livestock", "Legumes", "Herbs", "Other"];
  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
      ...
      <View style={styles.stepCard}>
        ...
        <Pressable style={styles.dropdownButton} onPress={() => setCategoryOpen(true)}>
          <Text style={styles.dropdownButtonText}>{category || "Select a category"}</Text>
          <Ionicons name="chevron-down" size={18} color="#1E7A35" />
        </Pressable>
      </View>
            ...
            {categories.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {active ? <Ionicons name="checkmark" size={16} color="#EAF8EE" /> : null}
                </Pressable>
              );
            })}
          </Pressable>
      ...
      <View style={styles.stepCard}>
        ...
        <TextInput
          placeholder="Price in Kilo Grams (₦/kg)"
          value={price}
        ...
        <TextInput
          placeholder="Quantity in Kilo Grams (kg)"
          value={quantity}
